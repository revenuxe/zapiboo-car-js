...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About ZAPIBOO | Doorstep Scrap Collection in Bangalore" },
      {
        name: "description",
        content:
          "Learn about ZAPIBOO, a scrap collection platform built on scrap market roots from the 1980s and brought online in 2025 by Revenuxe.",
      },
      { property: "og:title", content: "About ZAPIBOO | Doorstep Scrap Collection in Bangalore" },
      {
        property: "og:description",
        content:
          "ZAPIBOO combines decades of scrap market experience with a modern online booking platform for Bangalore homes and businesses.",
      },
    ],
...
const timeline = [
  ...
  },
  {
    ...
    text: "ZAPIBOO now connects customers, pickup agents, scrap shops and recycling partners through a simpler digital workflow.",
  },
];
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="ZAPIBOO is built on roots in the scrap market from the 1980s and brought online in 2025 to make scrap pickup clearer, faster and more reliable."
      />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          <Reveal>
            <div className="space-y-6">
              ...
              <p>
                ZAPIBOO was created to bring that ground-level knowledge into a modern doorstep
            ...
            <div className="grid gap-10 rounded-[2.5rem] border border-white/10 bg-white/5 p-8 shadow-[0_40px_120px_rgba(15,23,42,0.35)] md:grid-cols-[1.2fr_0.8fr] md:p-12">
              <div className="space-y-6">
                ...
                <p className="max-w-2xl text-lg text-white/80">
                  Revenuxe powers ZAPIBOO with a thoughtful platform experience, blending marketplace expertise, service reliability and a bold vision for cleaner materials reuse.
                </p>
